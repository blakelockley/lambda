...
def test_function_body():
    ...
    assert expr == Function(Symbol("x"), Application(Symbol("x"), Symbol("y")))
...
def test_function_nested():
    ...
    assert expr == Function(Symbol("x"), Function(Symbol("z"), Symbol("z")))
...
def test_function_nested_no_parans_application():
    ...
    assert expr == Function(
        Symbol("x"), Function(Symbol("z"), Application(Symbol("z"), Symbol("a")))
    )
...
def test_func_symbol_application():
    ...
    assert expr == Application(Function(Symbol("x"), Symbol("x")), Symbol("y"))
...
def test_func_func_application():
    ...
    assert expr == Application(
        Function(Symbol("x"), Symbol("x")), Function(Symbol("y"), Symbol("y"))
    )
...
def test_func_symbol_nested_func():
    ...
    assert expr == Function(
        Symbol("x"), Application(Symbol("x"), Function(Symbol("y"), Symbol("y")))
    )
...
def test_func_nested_func_application():
    ...
    assert expr == Application(
        Function(Symbol("x"), Symbol("x")),
        Function(
            Symbol("y"), Application(Function(Symbol("a"), Symbol("a")), Symbol("y"))
        ),
    )
